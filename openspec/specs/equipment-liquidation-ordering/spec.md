# equipment-liquidation-ordering Specification

## Purpose

Define the opt-in ordering contract that keeps exact liquidation equipment at
the end of paginated equipment results and orders that group chronologically by
decommission date while preserving compatibility for other callers.
