...
Template mới điền sẵn bốn nhóm gợi ý nhưng cho phép người dùng thêm, đổi tên, xóa hoặc sắp xếp nhóm bằng các dòng dữ liệu hợp lệ. Template không hỗ trợ thêm cột nội dung tùy ý; cột ngoài contract của phiên bản template bị từ chối.
