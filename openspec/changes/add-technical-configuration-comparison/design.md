...
4. Sau P5D và trước bề mặt tài liệu đầu tiên ở P7B, thêm shared URL attachment primitives rồi chuyển Equipment sang primitive đó với regression coverage.
