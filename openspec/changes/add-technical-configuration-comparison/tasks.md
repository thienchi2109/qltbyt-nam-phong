...
- [ ] P2.2 Thêm bốn nhóm gợi ý dưới dạng records chỉnh sửa được; không dùng enum hoặc validation khóa tên nhóm.
- [ ] P2.3 Thêm ordering, criterion codes, multiline text và transactional mutations với fixed structural fields.
- [ ] P2.4 Thêm optimistic concurrency và structured errors.
- [ ] P2.5 Chạy DB phase gate cho quyền, grants/RLS, ownership/cascade và migration.
- [ ] P2.6 Viết tests cho nhóm mặc định, tùy biến nhóm, hai cấp, reorder, duplicate code, rollback và conflict.
...
- [ ] P3B.1 Thêm editor hai cấp group/criterion theo chiều dọc với bốn nhóm gợi ý có thể chỉnh sửa.
- [ ] P3B.2 Thêm reorder, multiline content và explicit `Lưu`.
- [ ] P3B.3 Không thêm schema builder hoặc custom content-column controls.
- [ ] P3B.4 Thêm unsaved, failed-save và optimistic-conflict preservation.
- [ ] P3B.5 Tích hợp editor vào workspace shell mà không làm shell phình to.
- [ ] P3B.6 Viết focused React tests và browser verification.
...
- [ ] P5.2 Điền sẵn bốn nhóm gợi ý nhưng cho phép thay đổi nhóm bằng dòng dữ liệu; giữ tập cột template cố định.
- [ ] P5.3 Thêm parser/validator và preview độc lập UI; từ chối cột nội dung ngoài contract.
- [ ] P5.4 Thêm lỗi theo dòng, duplicate detection và atomic import.
- [ ] P5.5 Thêm expected-revision guard cho target draft và giữ preview khi conflict.
- [ ] P5.6 Thêm import UI chỉ cho bản nháp.
- [ ] P5.7 Viết round-trip, nhóm tùy biến, extra-column, Unicode, multiline, malformed, conflict và version-mismatch tests.
