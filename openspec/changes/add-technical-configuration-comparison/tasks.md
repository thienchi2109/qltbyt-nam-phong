...
- [ ] P7B1.1 Thêm document URL metadata và criterion citations cho baseline và từng sản phẩm tham chiếu.
- [ ] P7B1.2 Dùng một paginated
...
- [ ] P7B1.3 Reuse document cho nhiều tiêu chí không sao chép URL.
- [ ] P7B1.4 Giữ owner rõ ràng để trích dẫn sản phẩm tham chiếu không bị trộn với baseline hoặc phương án.
- [ ] P7B1.5 Enforce expected revision, archived/locked immutability, affected-link count và locked-copy remapping.
- [ ] P7B1.6 Tạo
...
- [ ] P7B1.7 Thêm typed RPC names, wire types, module-local wrappers và RPC allowlist mà không đổi shared RPC helper.
- [ ] P7B1.8 Chạy DB phase gate cho quyền, ownership,
...
- [ ] P7B1.9 Không thêm document/citation UI hoặc URL-document consumer mới.
