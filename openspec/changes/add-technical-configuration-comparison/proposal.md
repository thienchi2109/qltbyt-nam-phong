...
- Cho phép xây dựng cấu hình cơ sở theo mô hình text-first gồm hai cấp `Nhóm cấu hình -> Tiêu chí`, hỗ trợ nhập thủ công, nhập nhanh nhiều dòng, sắp xếp và import template Excel chuẩn của hệ thống.
...
- Cho phép khai báo nhiều sản phẩm tham chiếu tùy chọn, tách biệt với các phương án cấu hình của nhà cung cấp.
...
- Cung cấp ma trận so sánh để quét nhanh cấu hình cơ sở với nhiều phương án, cùng workflow đánh giá thủ công từng phương án bằng danh sách tiêu chí và panel chi tiết.
