...
- Source-contract synthetic fixtures cover every parsed AST form, `ImportTypeNode`,
  JSDoc `import()`/`@import`, wrapped ambient loader roots, runtime constructor
  escapes, computed-reference fail-closed behavior, TS/JS extension inventory
  drift and missing/extra module specifiers before the production source check
  is trusted.
