...
The Dashboard, Equipment desktop actions, Equipment mobile actions, and QR scanner repair actions SHALL all use the same create-intent API to navigate into the Repair Requests create flow.
