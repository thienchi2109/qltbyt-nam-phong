## Why
The application currently lacks a real-time notification system. To validate the technical approach and provide immediate value, we will implement a **4-hour MVP** focusing solely on **High-Priority Repair Requests**. This will allow technicians to respond faster to critical equipment failures without waiting for full system implementation.

## What Changes
- **MVP Scope**:
    - **Trigger**: Only "New Repair Request" events.
