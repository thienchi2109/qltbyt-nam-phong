...
### Deep Thinking & Analysis Guidelines
- **UTILIZE** Sequential thinking MCP tool for complex problem-solving tasks requiring:
...
- **LEVERAGE** cognitive analysis tools when facing ambiguous requirements or system design challenges
- **APPLY** structured thinking for database schema changes, role-based access modifications, and multi-tenant feature implementations
- **USE** reflection and hypothesis testing for debugging complex issues or investigating system behavior
...
Global Rules for Code Modification Agent
...
- Deploy without running type checks
