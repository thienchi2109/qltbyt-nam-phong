-- P2A lock-free metadata validation for hierarchical baseline import preview.
BEGIN;
...
REVOKE ALL ON FUNCTION public._technical_configuration_baseline_import_validate_metadata_v2(UUID, JSONB, BIGINT) FROM PUBLIC, anon, authenticated, service_role;
