-- Fix: Add yeu_cau_id as separate column in lich_su_thiet_bi INSERT
-- for transfer_request_complete. Previously embedded only in chi_tiet JSONB,
-- preventing idx_lich_su_thiet_bi_yeu_cau_id index usage.
-- Keeps yeu_cau_id in chi_tiet for backward compatibility with existing queries.
