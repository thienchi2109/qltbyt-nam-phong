-- Migration: Fix transfer_request_list_enhanced tenant scope for regional leader
-- Date: 2026-02-16
-- Issue: regional_leader without p_don_vi could read cross-tenant rows due to NULL filter fallback.
