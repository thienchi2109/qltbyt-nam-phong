-- Fix dashboard_recent_activities JWT claim fallback handling.
-- - Empty-string app_role should fall back to role
-- - Empty-string user_id should fall back to sub
-- - Non-numeric don_vi claims should fail closed as NULL instead of 22P02
