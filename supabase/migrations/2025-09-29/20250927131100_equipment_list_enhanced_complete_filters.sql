-- Add missing filter parameters to equipment_list_enhanced RPC
-- Enables complete server-side filtering for users and locations
-- Date: 2025-09-27
...
-- Grant with new signature including all filter parameters
GRANT EXECUTE ON FUNCTION public.equipment_list_enhanced(TEXT, TEXT, INT, INT, BIGINT, TEXT, TEXT[], TEXT, TEXT[], TEXT, TEXT[], TEXT, TEXT[], TEXT, TEXT[], TEXT) TO authenticated;