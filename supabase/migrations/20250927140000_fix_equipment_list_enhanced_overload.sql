-- Fix equipment_list_enhanced function overloading conflict
-- Drop all existing versions and create single definitive version
-- Date: 2025-09-27

BEGIN;

-- Drop all existing equipment_list_enhanced function overloads
DROP FUNCTION IF EXISTS public.equipment_list_enhanced(TEXT, TEXT, INT, INT, BIGINT, TEXT, TEXT, TEXT, TEXT);
DROP FUNCTION IF EXISTS public.equipment_list_enhanced(TEXT, TEXT, INT, INT, BIGINT, TEXT, TEXT[], TEXT, TEXT, TEXT);
DROP FUNCTION IF EXISTS public.equipment_list_enhanced(TEXT, TEXT, INT, INT, BIGINT, TEXT, TEXT[], TEXT, TEXT[], TEXT, TEXT[], TEXT, TEXT[], TEXT, TEXT[], TEXT);

-- Create single definitive version with all filter parameters
