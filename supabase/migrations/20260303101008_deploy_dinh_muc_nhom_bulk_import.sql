...
-- Date: 2026-03-03
-- Purpose: Ensure dinh_muc_nhom_bulk_import is deployed through migration history
-- and does not rely on out-of-band/manual database changes.
-- Canonical implementation aligned with 20260205_dinh_muc_nhom_bulk_import.sql.
