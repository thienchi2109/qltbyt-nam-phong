-- Re-assert the safe dashboard_recent_activities RPC at the end of the chain.
-- Reason: 20260411_dashboard_recent_activities_rpc.sql used a non-standard
-- version prefix, so it sorts after 20260411123000_fix_dashboard_recent_activities_safe_tenant_cast.sql
-- and would otherwise overwrite the safe function on fresh migration runs.
