-- Migration: Keep unified import success as JSON boolean
-- Date: 2026-03-04
-- Purpose:
--   Ensure public.dinh_muc_unified_import returns `success` as boolean,
--   not text, by using JSON extraction operator -> instead of ->>.
