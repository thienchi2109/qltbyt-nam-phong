-- Fix ai_equipment_lookup ordering to use the real thiet_bi timestamp column.
-- The table exposes created_at, not updated_at, so the previous ORDER BY
-- raised PostgreSQL error 42703 at runtime.
