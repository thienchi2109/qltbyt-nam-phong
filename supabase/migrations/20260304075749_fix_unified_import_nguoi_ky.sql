-- Migration: Fix unified import missing nguoi_ky / chuc_vu_nguoi_ky
-- Date: 2026-03-04
-- Purpose:
--   The INSERT INTO quyet_dinh_dinh_muc was missing the NOT NULL columns
--   nguoi_ky and chuc_vu_nguoi_ky, causing a deterministic crash.
--   Since this creates a draft decision, placeholder values are acceptable
--   and the user can update them before activating the decision.
