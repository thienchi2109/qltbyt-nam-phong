-- Fix Column References in Equipment List Functions - Final Version
-- Issue: Functions reference non-existent columns (nv.active, count)
-- Solution: Remove references to non-existent columns and fix query structure
-- Migration Date: 2025-10-04 07:40 UTC
...
BEGIN
  ...
  WHERE (v_effective IS NULL OR nv.don_vi = ANY(v_effective))
...
-- Test 3: Test all equipment functions with fixed column references
