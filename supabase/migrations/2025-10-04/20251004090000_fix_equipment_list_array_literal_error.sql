-- Fix Equipment List Array Literal Error - Regional Leader Access
-- Issue: equipment_list_enhanced uses quote_literal() on BIGINT[] causing "malformed array literal" error
-- Root Cause: Line 119 converts v_allowed_don_vi array to string incorrectly
-- Solution: Use proper array formatting with array_to_string() or direct array syntax
-- Migration Date: 2025-10-04 09:00 UTC

BEGIN;

-- ============================================================================
-- UPDATE: equipment_list_enhanced to fix array literal error
-- ============================================================================
...
'Enhanced equipment list with multi-filter support and regional leader access. 
FIXED: Array literal error by using ARRAY[] constructor instead of quote_literal on BIGINT arrays.';
...
/*
-- Test 1: Test regional leader access with array filtering
SELECT * FROM public.equipment_list_enhanced(NULL, 'id.asc', 1, 10, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);

-- Test 2: Test with specific tenant filter
SELECT * FROM public.equipment_list_enhanced(NULL, 'id.asc', 1, 10, 15, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);

-- Test 3: Test with search query
SELECT * FROM public.equipment_list_enhanced('test', 'ma_thiet_bi.desc', 1, 10, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);

-- Test 4: Test with array filters
SELECT * FROM public.equipment_list_enhanced(
  NULL, 'id.asc', 1, 10, NULL, 
  NULL, ARRAY['Khoa A', 'Khoa B'], 
