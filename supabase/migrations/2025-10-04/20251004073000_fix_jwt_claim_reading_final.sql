-- Fix JWT Claim Reading - Final Version
...
-- Migration Date: 2025-10-04 07:30 UTC
...
BEGIN
    ...
    v_result := jsonb_build_object(
        ...
        'app_role', COALESCE(public._get_jwt_claim('app_role'), public._get_jwt_claim('role'), 'NULL'),
        'role', COALESCE(public._get_jwt_claim('role'), 'NULL'),
        'don_vi', COALESCE(public._get_jwt_claim('don_vi'), 'NULL'),
        'dia_ban', COALESCE(public._get_jwt_claim('dia_ban'), 'NULL'),
        'user_id', COALESCE(public._get_jwt_claim('user_id'), 'NULL'),
...
-- ============================================================================
-- UPDATE: equipment_users_list_for_tenant with fallback handling
-- ============================================================================
...
-- ============================================================================
-- UPDATE: equipment_locations_list_for_tenant with fallback handling
-- ============================================================================
...
-- ============================================================================
-- UPDATE: equipment_statuses_list_for_tenant with fallback handling
-- ============================================================================
...
-- ============================================================================
-- UPDATE: departments_list_for_tenant with fallback handling
-- ============================================================================
