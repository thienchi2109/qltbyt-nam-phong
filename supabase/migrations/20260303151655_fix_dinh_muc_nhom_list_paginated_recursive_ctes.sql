-- Migration: Fix recursive CTE usage in dinh_muc_nhom_list_paginated
-- Date: 2026-03-03
-- Problem:
--   The function used self-referencing CTEs (ancestors, category_tree)
--   with plain WITH, which fails at runtime with:
--   42P01: relation "ancestors" does not exist
-- Solution:
--   Use WITH RECURSIVE so both recursive CTEs are valid.
