-- Migration: Narrow usage_log_list user projection to safe fields
-- Date: 2026-02-20
-- Issue: usage_log_list(text, ...) used to_jsonb(u), which can expose sensitive
-- nhan_vien columns. Use explicit jsonb_build_object like the other overload.
