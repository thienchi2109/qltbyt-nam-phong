-- Entry 35 migration-specific companion; fixture-only until exact mapping and Chunk 6 cutover.
-- Document workflow includes cross-version validation, not JWT/tenant isolation.
