-- supabase/tests/repair_request_active_for_equipment_smoke_migration_specific.sql
...
BEGIN
  ...
  RAISE NOTICE 'repair_request_active_for_equipment smoke: migration_specific scenarios passed';
END;
$$;
