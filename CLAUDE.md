...
This project is indexed by GitNexus as **qltbyt-nam-phong-new** (2936 symbols, 6710 relationships, 178 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/qltbyt-nam-phong-new/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/qltbyt-nam-phong-new/context` | Codebase overview, check index freshness |
| `gitnexus://repo/qltbyt-nam-phong-new/clusters` | All functional areas |
| `gitnexus://repo/qltbyt-nam-phong-new/processes` | All execution flows |
| `gitnexus://repo/qltbyt-nam-phong-new/process/{name}` | Step-by-step execution trace |
