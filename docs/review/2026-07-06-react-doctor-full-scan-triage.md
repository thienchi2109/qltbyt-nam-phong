...
| `Security / low-supply-chain-score / error`     |     1 | `package.json:138`                                                                                                      | One flagged unused runtime dependency has been removed. Continue reviewing the remaining `vitest` advisory separately.                                                                          |
