...
| `Security / low-supply-chain-score / error`     |     2 | `package.json:54`, `package.json:138`                                                                                   | Review `@morphllm/morphmcp` and `vitest` advisories. `vitest` likely needs dependency update review; `@morphllm/morphmcp` needs confirmation that it is still required.                         |
