...
- [Playbook Rollback AI Provider Trên Vercel](./ai/vercel-ai-provider-rollback-playbook.vi.md) - Hai bộ lệnh Vercel CLI để rollback về Google trực tiếp hoặc Google qua gateway
