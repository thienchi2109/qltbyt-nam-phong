...
import {
  chooseExcelAction,
  createCurrentDataWorkbookExpectation,
...
describe("technical configuration baseline download actions", () => {
  ...
  it("downloads the complete current hierarchy with stable identity and visible titles", async () => {
    ...
    expect(model).toMatchObject(createCurrentDataWorkbookExpectation(expect.any(String)))
    await act(async () => {
