...
describe("technical configuration workspace shell source boundaries", () => {
  it("keeps the shell thin and baseline responsibilities extracted before the threshold", () => {
    ...
    const files = [
      ...
      "_components/TechnicalConfigurationBaselineVersionControls.tsx",
      "_components/TechnicalConfigurationVersionBar.tsx",
      "_components/TechnicalConfigurationBaselineProductionActions.tsx",
