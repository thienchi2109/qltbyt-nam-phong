...
describe("DeviceQuotaCategoryAssignedEquipment", () => {
  ...
  it("shows loading skeletons while fetching", () => {
    ...
    render(<DeviceQuotaCategoryAssignedEquipment nhomId={42} donViId={1} />, {
  ...
  it("uses panel presentation with horizontal table scroll and long-text guards", async () => {
    const longName =
      "Máy siêu âm Doppler màu tim mạch cấu hình cao dùng cho phòng can thiệp với tên thiết bị rất dài"
    ...
    render(<DeviceQuotaCategoryAssignedEquipment nhomId={42} donViId={1} variant="panel" />, {
      wrapper: createWrapper(),
    })
  ...
  it("does not present a failed assigned-equipment RPC as an empty assignment", async () => {
    ...
    render(<DeviceQuotaCategoryAssignedEquipment nhomId={24} donViId={17} />, {
      wrapper: createWrapper(),
    })
  ...
  it("calls RPC with correct arguments", async () => {
    ...
    render(<DeviceQuotaCategoryAssignedEquipment nhomId={99} donViId={7} />, {
      wrapper: createWrapper(),
    })
