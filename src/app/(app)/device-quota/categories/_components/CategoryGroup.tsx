  ...
  return (
    ...
    >
      <Tooltip>
          ...
          >
            ...
            <span className="relative min-w-0" style={{ paddingLeft: `${indentPx}px` }}>
              ...
              <span className="flex min-w-0 items-baseline gap-2">
                <span className="w-16 shrink-0 truncate text-sm font-semibold text-primary/80">
                  {category.ma_nhom}
                </span>
                <span className="min-w-0 flex-1 line-clamp-2 text-sm text-foreground/80">
                  {category.ten_nhom}
                </span>
              </span>
              {category.mo_ta && (
        ...
        <TooltipContent className="max-w-sm whitespace-normal">{category.ten_nhom}</TooltipContent>
      </Tooltip>
      ...
      <div className="rounded-lg border bg-card overflow-hidden transition-shadow hover:shadow-sm">
        ...
        >
              ...
              <TooltipTrigger asChild>
                ...
                >
                  <span className="flex min-w-0 items-start gap-2">
                    <span className="w-16 shrink-0 truncate text-sm font-bold text-primary">
                      {root.ma_nhom}
                    </span>
          ...
          <div aria-label={leafIds.has(root.id) ? "Danh mục lá" : "Danh mục cha"}>
            <QuotaProgressBar current={totalEquipment} max={quotaMax} />
          </div>
