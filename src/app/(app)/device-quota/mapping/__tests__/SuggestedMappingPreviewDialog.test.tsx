...
import type {
  ...
  SuggestMappingStatus,
  SuggestedGroup,
  SaveStatus,
  BatchSaveResult,
} from "../../_hooks/useSuggestMapping"
import { SuggestedMappingGroupSection } from "../../_components/suggested-mapping/SuggestedMappingGroupSection"
import { SuggestedMappingUnmatchedSection } from "../../_components/suggested-mapping/SuggestedMappingUnmatchedSection"
...
describe("SuggestedMappingUnmatchedSection", () => {
  ...
  it("does not render when unmatched is empty", () => {
    const { container } = render(<SuggestedMappingUnmatchedSection unmatched={[]} />)
...
describe("SuggestedMappingPreviewDialog", () => {
  ...
  it("renders footer disclaimer always visible", () => {
    ...
    expect(screen.getByText(/đây chỉ là gợi ý phân loại/i)).toBeInTheDocument()
  })
