...
describe("MappingPreviewFooterNote", () => {
  it("renders the provided message", () => {
    ...
    expect(screen.getByText(/Đây chỉ là gợi ý phân loại/)).toBeInTheDocument()
  })

  it("renders with info icon", () => {
    const { container } = render(<MappingPreviewFooterNote message="Test note" />)
...
describe("MappingPreviewEquipmentItem", () => {
  ...
  it("renders equipment name and code", () => {
    render(<MappingPreviewEquipmentItem item={item} isExcluded={false} onToggle={() => {}} />)
  ...
  it("shows restore button and line-through when excluded", () => {
    render(<MappingPreviewEquipmentItem item={item} isExcluded={true} onToggle={() => {}} />)
  ...
  it("calls onToggle when button is clicked", () => {
    ...
    render(<MappingPreviewEquipmentItem item={item} isExcluded={false} onToggle={onToggle} />)
