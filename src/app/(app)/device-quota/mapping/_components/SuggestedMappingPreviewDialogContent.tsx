...
import type { SuggestedMappingPreviewDialogProps } from "./SuggestedMappingPreviewDialog"
...
/**
 * Mounted dialog body that owns suggestion exclusion state for one open session.
 */
export function SuggestedMappingPreviewDialogContent({
    open,
    onOpenChange,
    donViId,
    userRole,
